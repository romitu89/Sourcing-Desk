...
return new class extends Migration
{
    ...
    {
        Schema::create('onboardeds', function (Blueprint $table) {
            $table->id('onboarded_id');
            $table->string('request_no');
            $table->unsignedBigInteger('submission_id');
            $table->string('onboarded_date');
            $table->string('onboarded_result');
    ...
    {
        Schema::dropIfExists('onboardeds');
    }
};
