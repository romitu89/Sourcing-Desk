...
import { faBell, faSearch, faChartBar, faChartColumn, faChartGantt, faChevronDown, faDesktop, faHome, faLayerGroup, faMagnifyingGlass, faMessage, faNetworkWired, faPaperclip, faPenToSquare, faPersonCircleQuestion, faPlus, faRectangleList, faTable, faUser, faUserCheck, faUserSecret, faXmark, faGears, faGear, faEnvelope, faRightFromBracket } from '@fortawesome/free-solid-svg-icons'

/* add icons to the library */
library.add(faUserSecret, faHome, faNetworkWired, faChartGantt, faUser, faXmark, faMagnifyingGlass, faGear, faEnvelope, faRightFromBracket,
