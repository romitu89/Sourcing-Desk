<template>
    <form @submit.prevent="submitForm">
     ...
     <td ><select id="location" v-model="tlSubmission.selectedLocation" name="location">
...
submitForm() {
    ...
    // if (this.isFormValid) {
        ...
        axios.post('/api/tlsubmission-approve', this.tlSubmission)
  .then(response => {
