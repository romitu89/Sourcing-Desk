<template>
        ...
        <tr>
          ...
          <td>
            <select
              ...
              @change="filterClientData"
              @blur="checkValidation('selectedLocation')"
              name="location"
            >
              <option value="">Select Location</option>
              <option
                v-for="item in uniqueLocations"
                :key="item"
                :value="item"
              >
                {{ item }}
        ...
        <tr v-if="client.clientName">
          ...
          <td>
            <select
              ...
              @blur="checkValidation('businessName')"
              name="business"
            >
              <option value="">Select B-Unit</option>
              <option
                v-for="item in filteredBusinessUnits"
  ...
  export default {
    ...
    computed: {
      uniqueLocations() {
        const locations = this.clientData.map(item => item.location);
