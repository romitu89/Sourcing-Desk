    ...
    <table class="input_form">
      ...
      <tr v-if="amRequest.jobType">
        ...
        <td>
          <select
            id="location"
            v-model="amRequest.selectedLocation"
            @change="fetchClients"
      ...
      <tr v-if="amRequest.selectedLocation">
        ...
        <td>
          <select
            id="client"
            v-model="amRequest.selectedClient"
      ...
      <tr v-if="amRequest.selectedClient">
        ...
        <td>
          <select
            id="business"
            v-model="amRequest.selectedBusiness"
      ...
      <tr v-if="amRequest.selectedBusiness">
        ...
        <td>
          <select
            v-model="amRequest.clientManager"
  ...
  computed: {
    ...
    uniqueClients() {
      return [
        ...new Set(
          this.client
            .filter((item) => item.location === this.amRequest.selectedLocation)
    ...
    uniqueBusinessUnits() {
      return [
        ...new Set(
          this.client
            .filter((item) => item.client_name === this.amRequest.selectedClient)
    ...
    uniqueManagers() {
        ...
        ...new Set(
          this.client
            .filter((item) => item.business_unit_name === this.amRequest.selectedBusiness)
