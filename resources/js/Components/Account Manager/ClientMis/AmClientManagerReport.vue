    ...
    <table class="input_form">
      <tr>
        ...
        <td>
          ...
          <span v-if="submitted && !validation.location" class="error"
      ...
      <tr>
        ...
        <td>
          <select id="client" v-model.trim="client.name" class="color_cell" name="client">
            <option value="">Choose Client</option>
            <option value="India">India</option>
            <option value="usa">USA</option>
          </select>
          <span v-if="submitted && !validation.name" class="error"
      ...
      <tr>
        ...
        <td>
          ...
          <span v-if="submitted && !validation.business" class="error"
      ...
      <tr>
        ...
        <td>
          ...
          <span v-if="submitted && !validation.manager" class="error"
            >Business Unit is required.</span
          >
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          ...
          <span v-if="submitted && !validation.matrix" class="error"
            >Matrix is required.</span
          >
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <input v-model.trim="client.from" type="date" />
          <span v-if="submitted && !validation.from" class="error"
      ...
      <tr>
        ...
        <td>
          <input v-model.trim="client.to" type="date" />
          <span v-if="submitted && !validation.to" class="error"
