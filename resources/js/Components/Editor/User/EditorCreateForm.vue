  ...
  <form @submit.prevent="submitForm">
    <table class="input_form">
      ...
      <tr>
        ...
        <td>
          <input v-model.trim="employee.dob" @blur="checkValidation('dob')" type="date" />
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      axios
        .post("/api/editoruser-create", this.employee)
        .then((response) => {
