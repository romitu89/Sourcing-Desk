...
namespace App\Http\Controllers\TeamLead\TeamManagement;
...
class TLTeamView extends Controller
{
    ...
    public function edit(string $id)
    {
        ...
        return response()->json(['result' => $team, 'teamData' => $tm, 'selectedTm' => $selectedTm]);
    }
