...
class TLTrackerView extends Controller
{
    ...
    public function edit(string $id)
    {
        ...
        return response()->json(['result' => $tracker, 'client' => $am]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $request->validate([
            ...
            'clientManagerName' => 'required|String',
        ...
        return response()->json(['message' => 'Tracker updated successfully']);
    }
